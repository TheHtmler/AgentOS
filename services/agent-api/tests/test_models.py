...
def test_core_model_tables_are_registered() -> None:
    ...
    assert {
        ...
        UserChannelBinding.__tablename__,
        ChannelBindingFlow.__tablename__,
        ChannelBindingInvite.__tablename__,
        ChannelBindingEvent.__tablename__,
        Agent.__tablename__,
        ...
        KnowledgeDocumentSnapshot.__tablename__,
        KnowledgeChunk.__tablename__,
        OpsSession.__tablename__,
        ModelProvider.__tablename__,
        PlatformToolPolicy.__tablename__,
        Thread.__tablename__,
        ScheduledTask.__tablename__,
        ScheduledTaskNotification.__tablename__,
