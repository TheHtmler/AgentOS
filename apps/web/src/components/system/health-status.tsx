...
export function HealthStatus() {
  ...
  return (
    <section aria-live="polite" className="border border-zinc-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-700 transition hover:border-zinc-500 hover:text-zinc-950 disabled:cursor-not-allowed disabled:opacity-50"
        >
          重新检查
        </button>
      </div>
